...
class WriteSQLdataState extends State<WriteSQLdata>{
  ...
  TextEditingController problemctl = TextEditingController();
  //text controller for TextField

  bool error, sending, success;
  String msg;

  String phpurl = "http://updatejewelry.com/rural_munici/samshya/write.php";
